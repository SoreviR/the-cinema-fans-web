  ...
  return (
    <Link href={`/${cardPage}/${cardId}`}>
      <div className="relative overflow-hidden w-44 h-60 rounded-xl cursor-pointer text-2xl font-bold bg-slate-950">
        ...
        <div className="absolute peer-hover:-top-20 peer-hover:-left-16 peer-hover:w-[140%] peer-hover:h-[140%] -top-60 -left-28 w-32 h-44  bg-slate-950 transition-all duration-500"></div>
        <div className="absolute flex text-xl text-center text-white items-end justify-end peer-hover:right-0 peer-hover:rounded-b-none peer-hover:bottom-0 peer-hover:items-center peer-hover:justify-center peer-hover:w-full peer-hover:h-full -bottom-60 -right-16 w-36 h-44 bg-slate-950 transition-all duration-500">
          <div className="flex flex-col gap-5">
            <span className="absolute flex bg-slate-500 py-[1px] px-1 rounded-lg top-1 right-4 text-sm">
              {startsCount(cardRate)}
            </span>
